...
function checkData(){
        ...
        if($checkrows>0) {
            ...
            header("Location: http://localhost/escrow/users/verification.php");
        } else {
            echo '<script>alert("Invalid transaction code"); location = "http://localhost/escrow/users/seller.php"</script>';
            exit;
